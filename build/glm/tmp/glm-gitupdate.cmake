...
execute_process(
  COMMAND "D:/Program Files/Git/cmd/git.exe" show-ref 0.9.7.1
  WORKING_DIRECTORY "D:/datorgrafik/Eda221/build/glm/src/glm"
...
# yet).
execute_process(
  COMMAND "D:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 0.9.7.1
  WORKING_DIRECTORY "D:/datorgrafik/Eda221/build/glm/src/glm"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/datorgrafik/Eda221/build/glm/src/glm/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/datorgrafik/Eda221/build/glm/src/glm/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "D:/Program Files/Git/cmd/git.exe" checkout 0.9.7.1
      WORKING_DIRECTORY "D:/datorgrafik/Eda221/build/glm/src/glm"
      RESULT_VARIABLE error_code
      )
    if(error_code)
